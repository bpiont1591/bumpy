...
if (!guildId) {
  if (onboardingMode) {
    statusNode.innerHTML = `
      ✅ Bot został dodany lub jesteś po kroku zaproszenia.<br/><br/>
      Aby uruchomić panel serwera:
      <ol>
        <li>Na swoim serwerze wykonaj <code>/invite kanał:#twoj-kanał</code>.</li>
        <li>Następnie wykonaj <code>/bump</code> na ustawionym kanale.</li>
        <li>Bot zwróci Ci prywatnie link do panelu serwera.</li>
      </ol>
      <small>Jeśli bot nie odpowiada, sprawdź uprawnienia: <b>Create Instant Invite</b> oraz <b>Use Application Commands</b>.</small>
    `;
  } else {
